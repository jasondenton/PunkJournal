...
\usepackage[xetex, landscape, /@sheet.paper_size@/paper, inner=0.5in, outer=0.5in, top=0.5in, bottom=0.5in]{geometry}
...
\begin{multicols*}{3}[\noindent {\Large \color{cyberred}/@name@/ \hfill /@title@/ }]
